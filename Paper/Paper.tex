...
\author{
    ...
    \IEEEauthorblockA{\textit{Faculty of Engineering} \\
        \textit{Cairo University}\\
        hassan.badawy@eng-st.cu.edu.eg}
    \and
...
\bibitem{bib:green} D. R. Green and G. Evan, "A matter of life and death," \textit{Cancer Cell}, vol. 1, no. 1, pp. 19-30, 2002.
\bibitem{bib:bagci} E. T.  Bagci, Y. Vodovotz, T. R. Billiar, et al., "Bistability in apoptosis," \textit{Biophysical Journal}, vol. 90, no. 5, pp. 1546-1559, 2006.
\bibitem{bib:laise} P. Laise, D. Fanelli, and A. Arcangeli, "A dynamical model of apoptosis and its role in tumor progression," \textit{Communications in Nonlinear Science and Numerical Simulation}, vol. 17, no. 4, pp. 1795-1804, 2012.
\bibitem{bib:butcher} J. C. Butcher, \textit{Numerical Methods for Ordinary Differential Equations}. John Wiley \& Sons, 2016.
\bibitem{bib:shampine} L. F. Shampine and M. W. Reichelt, "The MATLAB ODE suite," \textit{SIAM Journal on Scientific Computing}, vol. 18, no. 1, pp. 1-22, 1997.
\end{thebibliography}
